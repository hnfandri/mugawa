...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Okt 2021 pada 17.15
...
(3, 'Titik Fokus', 'Pengasih,pengasih, Kulon Progo', '081392627068', 5, 4, 3, 4, 5, 4, 3, 5, 4);
...
(1, 5, 1, -1, 1, 2, 1, 3, 0, 0, 0, 0),
(2, 7, 1, -1, 0, 0, 1, 2, -1, 0, -1, -2),
(3, 10, 1, 1, 1, 1, 0, 2, 0, 0, 0, -1),
(4, 11, 1, 1, 2, 2, 1, 3, 0, 2, 2, 0);
...
(11, 'Hesti Nur Ahyani', 'Prambanan, Plasoan, Klaten', '081392627068', 5, 5, 5, 5, 5, 5, 5, 5, 5);
...
(3, 'hesti nur ahyani', 'hestiahyani12@gmail.com', 'admin123'),
(4, 'Doughlas', 'hanifandri03@gmail.com', '$2y$10$DPb/rJDVmjh3GQx3U/8Nn.MyKKwcEq4yGSZExNysRzJPQuZIX7hRe');
